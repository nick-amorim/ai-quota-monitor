...
ai-quota-monitor is a self-hosted FastAPI application for monitoring two ChatGPT Plus/Codex accounts. It keeps account authentication isolated, reads Codex quota telemetry, schedules anchor turns, and exposes both a full dashboard and a compact Raspberry Pi monitor.

## Goals

- Make 5-hour and weekly Codex usage windows visible.
- Keep two ChatGPT Plus/Codex accounts independently authenticated.
...
- Default Account A and Account B seed records.
